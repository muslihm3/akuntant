...
class JurnalPenyesuaian extends BaseController
{
    ...
    public function index()
    {
        ...
        $rowdata=$this->objTransaksi->get_jpenyesuaian($userId,$tglawal,$tglakhir);
    ...
    { 
        ...
        $html = view('jurnalpenyesuaian/cetakjppdf', $data);
