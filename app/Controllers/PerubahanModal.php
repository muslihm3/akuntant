...
class PerubahanModal extends BaseController
{
    ...
    public function index()
    {
        ...
        $rowdata=$this->objTransaksi->get_perubahanmodal($userId,$tglawal,$tglakhir);
    ...
    public function cetakpmpdf()
    {
        ...
        $data['tglawal']=$tglawal;
        $data['tglakhir']=$tglakhir;
        $html = view('perubahanmodal/cetakpmpdf', $data);
       ...
       // Set font
        ...
        $pdf->Output('perubahanmodal.pdf', 'I');
    }
}
