...
<title>Sistem Akuntansi &mdash; Jurnal Penyesuaian</title>
<?= $this->endSection() ?>
                ...
                <div class="row g-3">
                  <div class="col">
                   ...
                   <div class="col">
                    ...
                    <input type="submit" class="btn btn-success" formtarget="_blank" formaction="jurnalpenyesuaian/cetakjppdf" value="Cetak PDF" >
                  </div>
                </div>
              </form>
            </div>
