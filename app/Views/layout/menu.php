<li class="menu-header">Dashboard</li>
              ...
              <li class="#"><a class="nav-link" href="<?=site_url('jurnalumum')?>"><i class="far fa-calendar-alt"></i></i> <span>Jurnal Umum</span></a></li>
              <li class="#"><a class="nav-link" href="<?=site_url('posting')?>"><i class="fas fa-pencil-alt"></i> <span>Posting</span></a></li>
              <li class="#"><a class="nav-link" href="<?=site_url('neracasaldo')?>"><i class="fas fa-money-check-alt"></i> <span>Neraca Saldo</span></a></li>
              <li class="#"><a class="nav-link" href="<?=site_url('neracalajur')?>"><i class="fas fa-money-check"></i> <span>Neraca Lajur</span></a></li>
              ...
              <li class="#"><a href="<?=site_url('admin')?>" class="nav-link"><i class="fas fa-users"></i> <span>Users</span></a></li>
              <?php endif;?>
