...
<title>Sistem Akuntansi &mdash; Laba Rugi</title>
<?= $this->endSection() ?>
                ...
                <div class="row g-3">
                  <div class="col">
                   ...
                   <div class="col">
                    ...
                    <input type="submit" class="btn btn-success" formtarget="_blank" formaction="labarugi/cetaklrpdf" value="Cetak PDF" >
                  </div>
                </div>
              </form>
            </div>
                ...
                <table class="table table-striped table-md" id="myTable">
                  <thead class="judul">
                    <tr>
                      ...
                      <td class="text-right" rowspan="2">Beban</td>
                    </tr>
                  </thead>
                  <tbody>
                    <?php
