...
<title>Sistem Akuntansi &mdash; Perubahan Modal</title>
<?= $this->endSection() ?>
                ...
                <div class="row g-3">
                  <div class="col">
                   ...
                   <div class="col">
                    ...
                    <input type="submit" class="btn btn-success" formtarget="_blank" formaction="perubahanmodal/cetakpmpdf" value="Cetak PDF" >
                  </div>
                </div>
              </form>
            </div>
                ...
                <table class="table table-striped table-md" id="myTable">
                  <thead class="judul">
                    <tr>
                      ...
                      <td class="text-center" colspan="2">Perubahan Modal</td>
