...
<title>Sistem Akuntansi &mdash; Akun 1</title>
<?= $this->endSection() ?>
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td class="text-center" style="width:15%">
                              ...
                              <button class="btn btn-danger btn-sm" data-confirm="Hapus Data...? | Apakah anda Yakin..?" data-confirm-yes="hapus(<?=$value->id_akun1?>)"><i class="fas fa-trash"></i>Del</button>
                            </form>
                            </td>
                          </tr>
                          <?php endforeach; ?>
