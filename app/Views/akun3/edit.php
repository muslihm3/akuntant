                  ...
                  <div class="card-body p-4">
                    ...
                    <input type="hidden" name="_method" value="PUT">
                      ...
                      <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="kode_akun3" placeholder="Kode Akun" value="<?= $dtakun3->kode_akun3?>" required>
                        </div>
                        <div class="form-group">
                          <label>Nama Akun 3</label>
                          <input type="text" class="form-control" name="nama_akun3" placeholder="Nama Akun" value="<?= $dtakun3->nama_akun3?>" required>
                        </div>
                        <div class="form-group">
