...
<title>Sistem Akuntansi &mdash; Akun 3</title>
<?= $this->endSection() ?>
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td class="text-center" style="width:15%">
                              <a href="<?= site_url('akun3/'. $value->id_akun3).'/edit' ?>" class="btn btn-warning btn-sm"><i class="fas fa-pencil-alt btn-small"></i>Edit</a>
                              <form action="<?=site_url('akun3/'.$value->id_akun3)?>" method="post" id="del<?=$value->id_akun3?>" class="d-inline">
                              <?=csrf_field();?>
                              <input type="hidden" name="_method" value="DELETE">
                              <button class="btn btn-danger btn-sm" data-confirm="Hapus Data...? | Apakah anda Yakin..?" data-confirm-yes="hapus(<?=$value->id_akun3?>)"><i class="fas fa-trash"></i>Del</button>
                            </form>
                            </td>
                          </tr>
                          <?php endforeach; ?>
