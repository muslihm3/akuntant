        ...
        <table border="0.1px" class="table table-striped" >
          <thead class="judul">
            <tr>
              ...
              <td class="aturtengah" colspan="2">Neraca Saldo</td>
              <td class="aturtengah" colspan="2">Jurnal Penyesuaian</td>
              <td class="aturtengah" colspan="2">NS yang disesuaikan</td>
              <td class="aturtengah" colspan="2">Laba Rugi</td>
              <td class="aturtengah" colspan="2">Neraca</td>
            </tr>
            <tr>
          ...
          <tbody>
            <?php
              ...
              <?php foreach ($dttransaksi as $key => $value): ?>
                ...
                ?>
            <tr>
              <td class="aturkiri"><?=$value->kode_akun3?></td>
              <td class="aturkiri"><?=$value->nama_akun3?></td>
              <td class="aturangka"><?= number_format( $debitnew,0,",",".")?></td>
              <td class="aturangka"><?= number_format( $kreditnew,0,",",".")?></td>
              <td class="aturangka"><?= number_format( $debitnewjp,0,",",".")?></td>
              <td class="aturangka"><?= number_format( $kreditnewjp,0,",",".")?></td>
              <td class="aturangka"><?= number_format( $debs,0,",",".")?></td>
              <td class="aturangka"><?= number_format( $kres,0,",",".")?></td>
              <td class="aturangka"><?= number_format( $lb_db,0,",",".")?></td>
              <td class="aturangka"><?= number_format( $lb_kr,0,",",".")?></td>
               <td class="aturangka"><?= number_format( $nrbs,0,",",".")?></td>
              <td class="aturangka"><?= number_format( $nrkd,0,",",".")?></td>
            </tr>
            <?php endforeach; ?>
          </tbody>
          <tfoot class="judul">
          ...
          <tr>
            ...
            <td class="aturangka"><?=number_format($tdjp,0,",",".")?></td>
            <td class="aturangka"><?=number_format($tkjp,0,",",".")?></td>
            <td class="aturangka"><?=number_format($totd,0,",",".")?></td>
            <td class="aturangka"><?=number_format($totk,0,",",".")?></td>
            <td class="aturangka"><?=number_format($lb_td,0,",",".")?></td>
            <td class="aturangka"><?=number_format($lb_tk,0,",",".")?></td>
            <td class="aturangka"><?=number_format($totns,0,",",".")?></td>
            <td class="aturangka"><?=number_format($totkd,0,",",".")?></td>
          </tr>
          </tfoot>
